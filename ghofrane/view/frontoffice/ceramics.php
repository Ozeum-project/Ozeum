...
<body>
    ...
    <div class="collection-filters">
        <a href="acceuil.php" class="filter-btn ">peinture</a>
        <a href="karakuri.php" class="filter-btn">karakuri</a>
        <a href="ceramics.php" class="filter-btn active">ceramic</a>
    </div>
    <div class="blog-divider"></div>
    
    <p class="blog-description">
        La céramique japonaise traditionnelle (yakimono - 焼き物) est une forme d’art ancienne qui remonte à la période Jōmon (vers 10 000 av. J.-C.). Elle se distingue par ses techniques variées, ses textures naturelles et son lien avec la philosophie du wabi-sabi (beauté de l’imperfection).</p>
