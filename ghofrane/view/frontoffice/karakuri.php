...
<body>
    ...
    <div class="collection-filters">
        ...
        <a href="karakuri.php" class="filter-btn active">karakuri</a>
...
<div class="blog-description">
    Les karakuri (絡繰り) sont des automates traditionnels japonais, créés entre le XVIIe et le XIXe siècle, principalement pendant l’époque Edo. Ces mécanismes ingénieux étaient utilisés pour le divertissement, souvent dans les maisons de samouraïs, les temples et les théâtres.
</div>
